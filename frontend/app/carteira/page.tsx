 ...
 * server decides (401/403), never this page. It is reached from the start screen
 * (TASK-026), the app's only entry point today besides /evolucao: there is no
 * global navigation, and none was added.
 */
export default function CarteiraPage() {
  return (
    <div className="flex min-h-screen justify-center px-6 py-16 md:px-10 md:py-24">
      <div className="w-full max-w-[960px]">
        <a href="/" className="mb-6 inline-block text-sm font-medium text-aligna-muted hover:text-aligna-ink">
          ← Voltar ao início
        </a>
